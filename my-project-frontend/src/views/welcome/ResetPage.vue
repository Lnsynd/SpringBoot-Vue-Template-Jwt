...
<template>
  <div style="text-align: center;">
    ...
    <div v-if="active===0" style="margin: 0 20px">
        ...
        <el-form :model="form" :rules="rule" ref="formRef">
          ...
          <el-form-item prop="code">
            <el-row :gutter="10" style="width: 100%">
              ...
              <el-col :span="5">
                <el-button type="success" @click="askCode" :disabled="coldTime > 0||!validateEmail">
      ...
      <div style="margin-top: 80px;">
        <el-button type="warning" plain style="width: 270px" @click="confirmReset">开始重置</el-button>
      </div>
    </div>
    <div style="margin: 0 20px" v-if="active === 1">
      ...
      <div style="margin-top: 80px;">
        <el-button type="warning" plain style="width: 270px" @click="doReset">立即重置</el-button>
      </div>
    </div>
  </div>
</template>
